...
/*A0*/	IMM, INX, IMM, INX, ZPG, ZPG, ZPG, INY, IMP, IMM, IMP, IMM, ABS, ABS, ABS, ABS, REL, INY, ERR, INY, ZPX, ZPX, ZPY, ABY, IMP, ABY, IMP, ABY, ABX, ABX, ABY, ABX,
...
/*B0*/	" BCS", " LDA", "*HLT", "*LAX", " LDY", " LDA", " LDX", "+LDA", " CLV", " LDA", " TSX", " ???", " LDY", " LDA", " LDX", "+LDA",
...
unsigned char Decrypt(unsigned char raw) {
	...
	if (which ==0 && RI.ConsoleType >=CONSOLE_VT02 && RI.ConsoleType <=CONSOLE_VT369 && RI.INES2_SubMapper >=10)
