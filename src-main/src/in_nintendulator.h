 ...
 *
 * $URL: svn+ssh://quietust@svn.code.sf.net/p/nintendulator/code/nintendulator/trunk/src/in_nintendulator.h $
 * $Id: in_nintendulator.h 1308 2014-09-10 21:41:40Z quietust $
 */
