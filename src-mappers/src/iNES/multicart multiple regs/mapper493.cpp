...
void	sync (void) {
	EMU->SetPRG_ROM32(0x8, outerBank <<1 | Latch::data     &1);
	EMU->SetCHR_ROM8 (0x0, outerBank <<3 | Latch::data >>4 &7);
	iNES_SetMirroring();
}
...
uint16_t mapperNum =493;
} // namespace

MapperInfo MapperInfo_493 ={
	&mapperNum,
	_T("AVE-NTDEC 30-in-1"),
	COMPAT_FULL,
	load,
	reset,
	NULL,
