...
void	sync (void) {
	...
	iNES_SetCHR_Auto2(0x0, (reg[reg[7] &1? 0: 0] &0x07 | reg[4] <<3) <<2 |0);
	iNES_SetCHR_Auto2(0x2, (reg[reg[7] &1? 0: 1] &0x07 | reg[4] <<3) <<2 |1);
	iNES_SetCHR_Auto2(0x4, (reg[reg[7] &1? 0: 2] &0x07 | reg[4] <<3) <<2 |2);
	iNES_SetCHR_Auto2(0x6, (reg[reg[7] &1? 0: 3] &0x07 | reg[4] <<3) <<2 |3);
	switch (reg[7] &7) {
...
uint16_t mapperNum =139;
} // namespace

MapperInfo MapperInfo_139 ={
	&mapperNum,
	_T("聖謙 SA8259C"),
	COMPAT_FULL,
	NULL,
